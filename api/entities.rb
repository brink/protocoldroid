  ...
  module Entities
    ...
    class API < Grape::API
      ...
      namespace :entities do
        desc 'Expose a tool', params: HaikuBot::Entities::Tool.documentation
        get ':id' do
          present OpenStruct.new(id: params[:id], length: 10, weight: '20kg'), with: HaikuBot::Entities::Tool, foo: params[:foo]
        end
      end
    end
  end
